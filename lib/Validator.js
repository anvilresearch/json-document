...
var Validator = function () {
  ...
  _createClass(Validator, [{
    ...
    value: function additionalValidations() {
      ...
      var additionalProperties = _schema.additionalProperties;
      var address = this.address;
    ...
    value: function additionalItems() {
      ...
      var items = _schema2.items;
      var additionalItems = _schema2.additionalItems;
      var address = this.address;
    ...
    value: function minimum() {
      ...
      var minimum = _schema3.minimum;
      var exclusiveMinimum = _schema3.exclusiveMinimum;
      var address = this.address;
    ...
    value: function maximum() {
      ...
      var maximum = _schema4.maximum;
      var exclusiveMaximum = _schema4.exclusiveMaximum;
      var address = this.address;
